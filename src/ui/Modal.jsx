...
function Modal({ open, onClose, title, children }) {
  ...
  return createPortal(
    <div className="backdrop-blur-sm text-title w-full h-screen fixed flex justify-center items-center top-0 left-0 bg-background/40 z-50">
      <div className="flex flex-col justify-center gap-y-4 p-4 border-2 border-subtitle rounded-xl bg-color w-[calc(100vw-2rem)] md:max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto">
