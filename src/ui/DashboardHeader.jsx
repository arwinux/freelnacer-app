      ...
      <div className="flex flex-col gap-y-12 justify-center items-start lg:max-w-7xl mx-auto">
        ...
        <div className="flex w-full items-center gap-y-4 flex-col sm:flex-row gap-x-3">
          <Link
            ...
            className="flex w-full sm:w-fit cursor-pointer hover:-translate-y-1.5 transition-all duration-300 hover:bg-primary-50 shadow-xl hover:shadow-primary-400 items-center justify-center gap-x-4 font-bold rounded-xl text-primary-500 bg-component py-3 px-6"
          >
            <FiPlus />
