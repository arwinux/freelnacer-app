      ...
      <div className="w-full relative bottom-12 grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 grid-flow-row gap-x-7 gap-y-5 lg:max-w-7xl mx-auto">
        <div className="flex flex-col dashboard-static-container overflow-hidden">
          ...
          <div className="w-full ring-border flex-1 flex flex-col gap-y-5 p-5 cursor-pointer select-none">
            ...
            <div className="flex items-center transition-all gap-x-2 bg-emerald-300/10 border border-emerald-200 rounded-xl px-2 py-2">
              <LuTrendingUp className="size-4 text-emerald-600" />
              <span className="font-bold text-emerald-700">1 open</span>
            </div>
          </div>
        </div>
